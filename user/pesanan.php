        ...
        <table class="min-w-full bg-white border border-gray-300">
            ...
            <tbody>
                <?php while ($pesanan = mysqli_fetch_assoc($query)): ?>
                    ...
                    <?php
                    if ($pesanan['status'] == 'Diproses') echo 'bg-yellow-500';
                    elseif ($pesanan['status'] == 'Dikirim') echo 'bg-blue-500';
                    elseif ($pesanan['status'] == 'Selesai') echo 'bg-green-500';
                    ?>">
                                <?php echo $pesanan['status']; ?>
                            </span>
                        </td>
                        <td class="px-6 py-4 border-b"><?php echo date('d/m/Y H:i', strtotime($pesanan['created_at'])); ?>
                        </td>
                        <td class="px-6 py-4 border-b">
